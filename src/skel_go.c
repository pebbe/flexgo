...
const char *skel1_go[] = {
  ...
  "m4_changequote([[, ]])",
  "",
  "/* TODO: version numbers -- flex.skl line 86",
  "",
  "#define FLEX_SCANNER",
  ...
  "}",
  "",
  "// yySTATE is the same as yy_START, it is for lex compatibility.",
  "func yySTATE() int {",
  "	return (yy_start - 1) / 2",
  "}",
  "",
  ...
  "var (",
  "	yy_hold_char byte",
  "	yy_n_chars   int   // number of characters read into yy_ch_buf",
  "	yyleng       int",
  "",
  "	// Points to current character in buffer",
  "	yy_c_buf_p int",
  "	yy_init    = false  // whether we need to initialize",
  ...
  ")",
  "",
  "func yy_new_buffer(file io.Reader, size int) *yy_buffer_state {",
  "	return yy_create_buffer(file, size)",
  "}",
  "",
  "func yy_set_interactive(is_interactive bool) {",
  ...
  "	}",
  "	b := yy_CURRENT_BUFFER()",
  "	b.yy_is_interactive = is_interactive",
  "}",
  "",
  "func yy_set_bol(at_bol int) {",
  "	if yy_CURRENT_BUFFER() == nil {",
  "		yyensure_buffer_stack ()",
  "		*(yy_CURRENT_BUFFER_LVALUE()) =",
  "			yy_create_buffer(yyin, yy_BUF_SIZE)",
  ...
  "m4_ifdef( [[M4_YY_USE_LINENO]],",
  "[[",
  "	yylineno = buffer.yy_bs_lineno",
  "	yycolumn = buffer.yy_bs_column",
  "]])",
  "}",
  "",
  ...
  "M4_YY_SC_DEFS",
  "",
  "// TODO: Reentrant structure and macros -- flex.skl line 817-920",
  "",
  "var (",
  "	yywrap  = func() bool { return true }",
  "    yyunput = yyunput_default",
  "    // TODO: input,  flex.skl line 1064",
  ")",
  "",
  ...
  "}",
  "",
  "func yyunput_default(c int, yy_bp int) {",
  ...
  " * M4_YY_DOC_PARAM",
  " */",
  "func yy_switch_to_buffer(new_buffer *yy_buffer_state) {",
  "    M4_YY_DECL_GUTS_VAR();",
  "",
  "//TODO: flex.skl line 2039-2078",
  "",
  "}",
  "",
  ...
  " * M4_YY_DOC_PARAM",
  " */",
  "func yy_delete_buffer(b *yy_buffer_state) {",
  "//TODO: flex.skl line 2149-2172",
  "}",
  "",
  ...
  " *  M4_YY_DOC_PARAM",
  " */",
  "func yypush_buffer_state(new_buffer *yy_buffer_state) {",
  "//TODO: flex.skl line 2264-2300",
  "}",
  "",
  ...
  " *  M4_YY_DOC_PARAM",
  " */",
  "func yypop_buffer_state() {",
  "//TODO: flex.skl line 2305-2329",
  "}",
  "",
  ...
  "}",
  "",
  "// omitted: yy_scan_buffer",
  "",
  "// omitted: yy_scan_string",
  "",
  "// omitted: yy_scan_bytes",
  "",
  "func yy_push_state(new_state int) {",
  "//TODO: flex.skl line 2501-2529",
  "}",
  "",
  "func yy_pop_state() {",
  "//TODO: flex.skl line 2536-2547",
  "}",
  "",
  "func yy_top_state() int {",
  "//TODO: flex.skl line 2554-2562",
  "	return 0",
  "}",
  "",
  "//TODO: Redefine yyless() so it works in section 3 code ????",
  "// flex.skl line 2587-2602",
  "",
  "",
  "%if-reentrant",
  "//TODO: Accessor  methods (get/set functions) to struct members",
  "// flex.skl line 2606-2936",
  "%endif",
  "",
  "",
  "",
