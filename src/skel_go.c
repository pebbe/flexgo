...
const char *skel1_go[] = {
  ...
  "",
  "	var yytext []byte",
  "	var yyleng, yylineno, yycolumn int",
  "	yyout := yy.Out",
  "	if false {",
  "		fmt.Print(yytext, yyleng, yylineno, yycolumn, yyout)",
  "	}",
  "",
