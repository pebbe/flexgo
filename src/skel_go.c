...
const char *skel1_go[] = {
  ...
  "m4_define( [[YYSTATE]], [[((yy.start - 1) / 2)]] )",
  "m4_define( [[YY_STATE_EOF]], [[(yyEndOfBuffer + $1 + 1)]] )",
  "m4_define( [[YY_USER_DATA]], [[m4_define(YY_MACRO_USER_DATA, $1)]] )",
  "m4_define( [[YY_USER_INIT]], [[m4_define(YY_MACRO_USER_INIT, $1)]] )",
  "m4_define( [[YY_USER_ACTION]], [[m4_define(YY_MACRO_USER_ACTION, $1)]] )",
  "",
  "",
  "type Scanner struct {",
  "	In   io.Reader",
  ...
  "	m4_define( [[YY_LESS_LINENO]], [[",
  "	for yyl := $1; yyl < yyleng; yyl++ {",
  "		if yytext[yyl] == '\\n' {",
  "			yy.Lineno--",
  "		}",
  "	}",
  "	]] )",
  "	m4_define( [[YY_LINENO_REWIND_TO]], [[",
  "	for p := yyCp - 1; p >= $1; p-- {",
  "		if yy.chBuf[p] == '\\n' {",
  "			yy.Lineno--",
  "		}",
  ...
  "}",
  "",
  "m4_ifdef( [[YY_MACRO_USER_DATA]],, [[",
  "  m4_define(YY_MACRO_USER_DATA, [[]])",
  "]])",
  "m4_ifdef( [[YY_MACRO_USER_INIT]],, [[",
  "  m4_define(YY_MACRO_USER_INIT, [[]])",
  "]])",
  "m4_ifdef( [[YY_MACRO_USER_ACTION]],, [[",
  "  m4_define(YY_MACRO_USER_ACTION, [[]])",
  "]])",
  "",
  "m4_define( [[YY_DO_BEFORE_ACTION]], [[",
  "		yy.textPtr = yyBp",
  "",
  ...
  "		yylessMacroArg := $1",
  "		m4_ifdef( [[M4_YY_USE_LINENO]], [[YY_LESS_LINENO(yylessMacroArg)]])",
  "		yy.chBuf[yyCp] = yy.holdChar",
  "		YY_RESTORE_YY_MORE_OFFSET",
  "		yyCp = yyBp + yylessMacroArg - YY_MORE_ADJ",
  "		yy.cBufP = yyCp",
  "		YY_DO_BEFORE_ACTION",
  "]] )",
  "",
  ...
  "	_ = yytext",
  "	_ = yyleng",
  "	m4_ifdef( [[M4_YY_USE_LINENO]], [[_ =  yylineno]] )",
  "",
  "	YY_MACRO_USER_DATA",
  "",
  "	if !yy.init {",
  ...
  "// SKEL ----------------------------------------------------------------",
  "",
  "	for yyCp = yy.textPtr + YY_MORE_ADJ; yyCp < yy.cBufP; yyCp++ {",
  "",
